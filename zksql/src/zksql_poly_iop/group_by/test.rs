...
mod test {
    ...
    fn test_group_by_count() -> Result<(), PolyIOPErrors> {
        ...
        let proving_agg_instr = vec![(0, AggregationTypes::Count, support_mult_poly.clone())];
        ...
        let verifier_agg_instr = vec![(0, AggregationTypes::Count, support_mult_comm.clone())];
    ...
    // fn test_group_by_with_advice_helper<E: Pairing, PCS>(
