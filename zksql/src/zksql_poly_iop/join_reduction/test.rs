...
//         let (l_sel_mle, r_sel_mle) = calc_join_reduction_lr_sel_advice(&poly_a_mle, &a_sel_mle, &poly_b_mle, &b_sel_mle);
//         let (mid_a_inclusion_m_mle, mid_b_inclusion_m_mle) = calc_join_reduction_mid_inclusion_advice(&poly_a_mle, &poly_b_mle, &l_sel_mle, &r_sel_mle);
